...
<head>
    ...
    <!-- Bootstrap core CSS -->
<?php include("./data_control/phpmagicbits.php");?>
    ...
    <main role="main" class="container-fluid skin_plasma " style="min-height:100vh;">
      <div class="row  justify-content-center pl-1 pr-1">
        <div class="row justify-content-center m-0 p-0 col-md-12 mb-3 ">  		              	
  			<div class="col-md-12 border-bottom text-center p-3 h2 d-none d-lg-block "> Light speed page editor </div>
  			<div class="col-md-12 border-bottom text-center p-3 d-lg-none  "> <b>Light speed page editor</b> </div>
       </div>
          ...
          <div class="col-md-2 p-0">
           ...
           <div class="row justify-content-center m-0 p-0 col-md-12" style="max-height:90vh; overflow:auto;" id="web_content_tbl_list"></div>
            <template id="load_elems">
                    ...
                    <div onclick="push_newval('web_content_uptoken', btoa('{{primkey}}'));initialize_web_content();mosyshow_elem('update_btn','');mosyshow_elem('del_btn','')" class=" cpointer row mb-2 skin_plasma text-dark mb-2 pt-2 pb-2 justify-content-center m-0 col-md-12  border-bottom shadow-sm" style="border-left:2px solid <?php echo $btn_bg ?>">
                      <div class="col-4 p-0">
                        <img src="{{section_pic}}" class=" " style="width:50px; height:50px; border-radius:50%;" id=""/>
                      </div>
            ...
            <input type="hidden" id="web_content_uptoken" name="web_content_uptoken"/>
            <input type="hidden" id="txt_site_cont_key" name="txt_site_cont_key"/>
          </div>
          <div class="col-md-9">                                  
            <div class="col-md-12 mb-3 h4 text-info"> <span id="txt_section_title_disp"></span> / <span id="txt_site_cont_key_disp"></span></div>
            ...
            <div class="row justify-content-left m-0 p-0 col-md-12">
              ...
              <div class="row justify-content-left p-2 border rounded_big mb-3 m-0 col-md-12 bg-light sticky_scroll" style="z-index:99">
                <img src="img/useravatar.png" id="src_section_pic" class="useravatar_small mr-3 cpointer mosy_msdn " data-mosy_msdn="mosy_img_pop(get_src('src_section_pic'), 'max-width:100%; max-height:70vh');glass_modal()"/>
              ...
              <div class="row justify-content-center m-0 p-0 col-md-12">
                ...
                <div class="form-group col-md-12">
                  ...
                  <input class="form-control" id="txt_section_title" name="txt_section_title" placeholder="Section Title" type="text">
                </div>

                <div class="form-group col-md-12 text-left">
                  <label > Content </label>
                  <textarea class="form-control" name="txt_dna_remark" id="txt_dna_remark" class="form-control" placeholder="Section Content " style="min-height:70vh;"></textarea>
                </div>
              </div>
            </div>
          </div>
